...
# {
use xarxa::phy::ChecksumCapabilities;
use xarxa::wire::*;
let repr = Ipv4Repr {
...
mod buf;
pub(crate) use buf::{
    Buf, copy_window_at, prefix, read_i32_at, read_u16_at, sub, write_i32_at, write_octets4_at,
    write_octets16_at, write_u16_at, write_u24_at,
};
