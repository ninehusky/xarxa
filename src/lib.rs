...
#![allow(unsafe_code)] // CEILING MEASUREMENT ONLY -- not a shippable state
...
//! application; however, the goal of _xarxa_ is not just to provide a simple interface
...
//! _xarxa_ makes no effort to conform to the OSI model as it is not applicable to TCP/IP.
//!
//! # The socket layer
...
//! They however are the bedrock of _xarxa_, and everything else is built on top of them.
//!
...
//! as well as any features not supported by _xarxa_.
//!
//! ## The packet layer
